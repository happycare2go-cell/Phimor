...
function createAIProvider({ config, env = process.env, fetchImpl = global.fetch, logger = null, modelPurpose = 'document' } = {}) {
  ...
  return new GeminiProvider({
    ...
    model: modelPurpose === 'explanation' ? config.ai.explanationModel : config.ai.documentModel,
