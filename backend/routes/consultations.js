...
const SAFE_CONSULTATION_ERROR_CODE = /^(?:CONSULTATION|CASE|MESSAGE|QUESTION|PHARMACIST|CLINICAL|CARE_PROFILE|PAYMENT|ORDER|TERMS|INTERNAL|UNAUTHENTICATED|INVALID|IDEMPOTENCY|RATE_LIMIT|EMERGENCY|RECONCILIATION|REALTIME|READ|TRUSTED|UNSUPPORTED|ACCESS|MEMBERSHIP|CENTER)_[A-Z0-9_]+$/;
