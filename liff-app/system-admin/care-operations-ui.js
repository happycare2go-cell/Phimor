(function initCareOperationsUI(root, factory) {
  ...
  return { CAPABILITY_LABELS, SUPPORTED_EVENT_TYPES, CLIENT_STATUS_LABELS, GROUP_LABELS, IDENTITY_POLICY_LABELS,
    ...
    buildClientStatusRequest, buildIntegrationDirectoryRequest, buildIntegrationOverviewRequest, buildIntegrationMappingInspectorRequest, buildCenterScopeRequest, buildEventScopeRequest, buildCredentialRequest,
